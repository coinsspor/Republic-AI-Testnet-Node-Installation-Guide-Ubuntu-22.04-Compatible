# Republic AI Testnet — v0.2.1 Binary Update (fix)
...
- **EVM coin info initialization** — resolves the nil pointer panic on `GetEVMCoinDenom()` that crashed all nodes via gossip propagation
- **Staking hooks initialization fix**
...
- **WRAI chain config** and rebuild with latest fixes

Release: [v0.2.1](https://github.com/RepublicAI/networks/releases/tag/v0.2.1)
...
cd $HOME
wget -O republicd_new https://github.com/RepublicAI/networks/releases/download/v0.2.1/republicd-linux-amd64

# 3. Verify SHA256 checksum
echo "d10991b623fa62ee0f3c42ad15abbaa246f89d73a82736fad090e607b7cc4b8f  republicd_new" | sha256sum -c
...
sudo mv /usr/local/bin/republicd /usr/local/bin/republicd_old_backup
...
| v0.2.0 fix deployed | 144,917 | Feb 4, ~14:51 |
| v0.2.1 rebuild | 146,729 | Feb 4, ~17:24 |
